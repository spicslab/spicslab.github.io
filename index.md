...
<div id="site-notice" class="notice">
  ...
  We are joining a Joint Task Force with several university and company research labs, which will be working (and studying) on two tracks, <strong style="color:#7245BA">AI Safety</strong> and <strong style="color:#1941D4">Optimizing PETs</strong>. If interested, same with other research fields -- if interested, read the contact page, and send the PI an email.
</div>
